import {CircleHelp , MessageSquareMore , Settings2, BellDot, Search} from 'lucide-react';


const Navbar = () => {
   return (
     <nav className="hidden md:flex flex-row-reverse fixed top-0 z-10 w-full p-2 mr-2 justify-items-end items-center md:left-[265px] bg-transparent">
     <div className='justify-between items-center flex flex-row p-2 flex-grow w-full max-w-[600px] mr-[350px] pl-10'>
       ...
       <div className="flex items-center justify-center space-x-2">
         <button type="button" className="flex rounded-full focus:ring-4 focus:ring-gray-300">
            <img className="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo"/>
            <h2 className='hidden lg:flex text-black text-lg font-bold p-0 pl-2'>Adeline H. Dancy</h2>
         </button>
       </div>
     </div>
